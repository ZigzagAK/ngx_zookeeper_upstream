...
qr/^server 127\.0\.0\.2:5555 addr=127\.0\.0\.2:5555;\n$/,
qr/^server 127\.0\.0\.3:5555 addr=127\.0\.0\.3:5555;\n$/,
qr/(server 127\.0\.[01]\.[456]:4444 addr=127\.0\.[01].[456]:4444;\n){4}/,
qr/^server 127\.0\.0\.5:4444 addr=127\.0\.0\.5:4444;\n$/,
qr/^server 127\.0\.0\.6:4444 addr=127\.0\.0\.6:4444;\n$/
]
